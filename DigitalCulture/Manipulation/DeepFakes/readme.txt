...
pre-trained Neural Networks to copy specific
 ...
 that are tested with second "discriminator" network that compares
 the realistic image with actual source data(photography/video) 
 to produce images very close to the real thing.
 https://en.wikipedia.org/wiki/Deepfake
 https://bigthink.com/surprising-science/nvidia-deepfake-image-study
